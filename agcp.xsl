    ...
    <html>
        ...
        <body>
            ...
            <div class="container" id="Intro">
                ...
                <p>Manoscritto ad opera di <b><xsl:value-of select="//tei:titleStmt//tei:author"></xsl:value-of></b>.</p>
                ...
                <p>FRUIZIONE:<xsl:value-of select="//tei:publicationStmt/tei:availability"></xsl:value-of></p>
            </div>
            <div>
            ...
            <div class="mostraRetro">
                <label for="retro8">
                  <input type="checkbox" id="retro8" name="Retro_8" class="apriRetro" /> RETRO
                </label>
            </div>
            <div class="img-wrapper">
                <xsl:element name="img">
            ...
            <div class="container-p9" id="Pagina9">
                ...
                <div class="mostraRetro">
                    <label for="retro9">
                      <input type="checkbox" id="retro9" name="Retro_9" class="apriRetro" /> RETRO
                    </label>
                </div>
                </div>
                <div class="img-wrapper">
